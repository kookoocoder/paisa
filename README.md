...
.venv/bin/paisa download --symbols RELIANCE.NS TCS.NS INFY.NS --period 3mo --interval 1d --force
.venv/bin/paisa nse-bhavcopy --date 2024-06-03
.venv/bin/paisa nse-bhavcopy --date 2024-07-08
.venv/bin/paisa backtest --symbols RELIANCE.NS TCS.NS INFY.NS --period 3mo --interval 1d --strategy ma-cross
.venv/bin/paisa stocksharp-export --symbols RELIANCE.NS TCS.NS INFY.NS --period 3mo --interval 1d --strategy ma-cross
dotnet build StockSharp/Samples/11_PaisaPaperHarness/11_PaisaPaperHarness.csproj
dotnet run --project StockSharp/Samples/11_PaisaPaperHarness/11_PaisaPaperHarness.csproj -- reports/stocksharp_bridge/ma-cross_20260619_220558/manifest.json
```
...
- `data/processed/`
- `data/raw/`
- `reports/backtest_ma-cross_20260619_215138/`
- `reports/stocksharp_bridge/ma-cross_20260619_220558/`
